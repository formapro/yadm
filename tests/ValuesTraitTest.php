...
class ValuesTraitTest extends \PHPUnit_Framework_TestCase
{
    public function testShouldAllowSetValuesAndGetPreviouslySet()
    {
        ...
        $this->assertSame($values, \Makasim\Yadm\get_object_values($obj));
    ...
    public function testShouldAllowSetSelfValueAndGetPreviouslySet()
    {
        ...
        $this->assertSame('aVal', $obj->getValue('self.aKey'));
        $this->assertSame(['self' => ['aKey' => 'aVal']], \Makasim\Yadm\get_object_values($obj));
        $this->assertSame(['self' => ['aKey' => 'aVal']], \Makasim\Yadm\get_object_changed_values($obj));
    }
    ...
    public function testShouldAllowUnsetPreviouslySetValue()
    {
        ...
        $this->assertSame(['aName' => ['aKey' => 'aVal']], \Makasim\Yadm\get_object_values($obj));
        $this->assertSame(['aName' => ['aKey' => 'aVal']], \Makasim\Yadm\get_object_changed_values($obj));
        ...
        $this->assertSame(['aName' => ['aKey' => null]], \Makasim\Yadm\get_object_changed_values($obj));
    }
